...
class cyclegan(object):
    ...
    def obtain_data(self):
        ...
        dataA = glob('../data_wonderland/{}/*.*'.format(self.dataset_dir + '/color_256'))
        dataB = glob('../data_wonderland/{}.*'.format(self.dataset_dir + '/edge_256/*'+self.edge_type))
        # pdb.set_trace()

        dataA = self.sort_paths(dataA)
        dataB = self.sort_paths(dataB)

        dstart, dend = 91, 143  # indix for training set 
        dataA = dataA[dstart:dend]
        dataB = dataB[dstart:dend]
        return dataA, dataB
    ...
    def load(self, checkpoint_dir):
        ...
        checkpoint_dir = os.path.join(checkpoint_dir, model_dir)
        # pdb.set_trace()
        ckpt_name_ = "cyclegan.model-" + "6002"
